...
<head>
    ...
    <title>Recovery Code — ~/dav/devs cms</title>
...
<body style="background:var(--cms-bg-page);color:var(--cms-text-primary);font-family:'Inter',sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;">
    <div style="background:var(--cms-bg-surface);border:1px solid var(--cms-border);border-radius:8px;padding:32px;width:100%;max-width:380px;">
        <div style="text-align:center;margin-bottom:24px;">
            ...
            <h1 style="font-size:20px;font-weight:600;margin:0;">Use Recovery Code</h1>
            <p style="font-size:13px;color:var(--cms-text-muted);margin:8px 0 0;">Enter one of your saved recovery codes.</p>
        </div>
        <form method="POST" action="{{ route('2fa.recovery.verify') }}">
            ...
            <div style="margin-bottom:16px;">
                <input type="text" name="code" autofocus
                       ...
                       style="width:100%;box-sizing:border-box;background:var(--cms-input-bg);border:1px solid var(--cms-input-border);border-radius:5px;padding:9px 12px;font-family:'JetBrains Mono',monospace;font-size:14px;letter-spacing:0.1em;text-align:center;color:var(--cms-input-text);text-transform:uppercase;">
        ...
        <div style="text-align:center;margin-top:16px;">
            <a href="{{ route('2fa.challenge') }}" style="font-size:12px;color:var(--cms-text-muted);text-decoration:none;">← Back to authenticator code</a>
        </div>
    </div>
</body>
</html>
