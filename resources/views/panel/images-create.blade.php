<x-cms-layout title="Upload Image">
    ...
    <form method="POST" action="{{ route('panel.images.store') }}" enctype="multipart/form-data" style="max-width:520px;">
        ...
        <div
            ...
            <div>
                <label
                    style="display:block;font-size:12px;font-weight:500;margin-bottom:6px;color:var(--cms-text-secondary);">File</label>
            ...
            <div>
                ...
                <textarea name="caption" rows="2"
                    style="width:100%;box-sizing:border-box;background:var(--cms-input-bg);border:1px solid var(--cms-input-border);border-radius:5px;padding:8px 12px;font-size:13px;color:var(--cms-input-text);">{{ old('caption') }}</textarea>
            </div>
            <div>
                <label
        ...
        <div style="display:flex;gap:10px;margin-top:16px;">
            <button type="submit"
                style="background:var(--cms-btn-primary-bg);color:var(--cms-btn-primary-text);border:none;border-radius:5px;padding:10px 20px;font-size:13px;font-weight:500;cursor:pointer;">Upload</button>
